...
const activateCopy = {
  ko: {
    ...
    passwordLabel: '비밀번호',
    passwordPlaceholder: '12자 이상, 대문자·소문자·숫자·특수문자 포함',
  ...
  en: {
    ...
    passwordPlaceholder: 'At least 12 characters with upper/lowercase, number, and special character',
    confirmPasswordLabel: 'Confirm password',
    confirmPasswordPlaceholder: 'Enter your password again',
    passwordPolicy: 'Your password must be at least 12 characters long and include uppercase, lowercase, a number, and a special character.',
